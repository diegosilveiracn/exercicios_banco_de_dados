...
\begin{document}
	...
	\begin{enumerate}
		...
		\item Selecione a quantidade de empregados por sexo.
		
		\item Selecione a quantidade de empregados por departamento.
		
		\item Selecione a quantidade de projetos por departamento.
		
		\item Selecione a média salarial por departamento.
		
		\item Selecione os maiores salário por sexo.
